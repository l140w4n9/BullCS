...
public class Loader {
   ...
   protected Set allocatorsrdll = new HashSet();
   protected Set variants = new HashSet();
   protected Set specialh = new HashSet();
   protected Set functionh = new HashSet();
   protected Set keyloggers = new HashSet();
   ...
   public Loader(String var1, String var2, Profile var3) {
      ...
      var3.addParameter(".maxdns", "");
      var3.addParameter(".dns_idle", "");
      var3.addParameter(".dns_sleep", "");
      var3.addParameter(".dns_stager_subhost", "");
      var3.addParameter(".dns_stager_prepend", "");
      var3.addParameter(".dns_max_txt", "");
      var3.addParameter(".dns_ttl", "");
      var3.addParameter(".dns-beacon.maxdns", "255");
      var3.addParameter(".dns-beacon.dns_idle", "0.0.0.0");
      var3.addParameter(".dns-beacon.dns_sleep", "0");
      var3.addParameter(".dns-beacon.dns_stager_subhost", "");
      var3.addParameter(".dns-beacon.dns_stager_prepend", "");
      var3.addParameter(".dns-beacon.dns_max_txt", "252");
      var3.addParameter(".dns-beacon.dns_ttl", "1");
      var3.addParameter(".tcp_port", "4444");
      var3.addParameter(".smb_frame_header", "");
      var3.addParameter(".tcp_frame_header", "");
      ...
      var3.addParameter(".stage.magic_mz_x86", "MZRE");
      var3.addParameter(".stage.magic_mz_x64", "MZAR");
      var3.addParameter(".stage.magic_pe", "PE");
      ...
      var3.addParameter(".stage.allocator", "VirtualAlloc");
      var3.addParameter(".stage.stomppe", "true");
      var3.addParameter(".stage.rich_header", "<DEFAULT>");
      var3.addParameter(".stage.smartinject", "false");
      var3.addParameter(".post-ex.pipename", "postex_####");
      ...
      var3.addParameter(".post-ex.thread_hint", "");
      var3.addParameter(".post-ex.keylogger", "GetAsyncKeyState");
      ...
      var3.addParameter(".http-config.block_useragents", "curl*,lynx*,wget*");
      var3.addParameter(".http-config.allow_useragents", "");
      var3.addList(".process-inject.execute");
      var3.addParameter(".ssh_banner", "CobaltStrike_4.5 I paid for threat intel and all I got was this default IOC");
      var3.addParameter(".ssh_pipename", "postex_ssh_####");
      var3.addParameter(".bind_tcp_garbage", CommonUtils.bString(CommonUtils.randomData(CommonUtils.rand(1024))));
      var3.addParameter(".dns-beacon.beacon", "");
      var3.addParameter(".dns-beacon.get_A", "");
      var3.addParameter(".dns-beacon.get_AAAA", "");
      var3.addParameter(".dns-beacon.get_TXT", "");
      var3.addParameter(".dns-beacon.put_metadata", "");
      var3.addParameter(".dns-beacon.put_output", "");
      var3.addParameter(".dns-beacon.ns_response", "");
      var3.addParameter(".malleableC2_profile", var2);
      ...
      this.options.add(".headers_remove");
      ...
      this.options.add(".dns-beacon.maxdns");
      this.options.add(".dns-beacon.dns_idle");
      this.options.add(".dns-beacon.dns_sleep");
      this.options.add(".dns-beacon.dns_max_txt");
      this.options.add(".dns-beacon.dns_ttl");
      this.options.add(".dns-beacon.dns_stager_prepend");
      this.options.add(".dns-beacon.dns_stager_subhost");
      ...
      this.options.add(".post-ex.thread_hint");
      this.options.add(".post-ex.keylogger");
      this.options.add(".post-ex.pipename");
      this.options.add(".ssh_banner");
      this.options.add(".ssh_pipename");
      this.options.add(".smb_frame_header");
      this.options.add(".tcp_frame_header");
      this.options.add(".dns-beacon.ns_response");
      this.options.add(".dns-beacon.beacon");
      this.options.add(".dns-beacon.get_A");
      this.options.add(".dns-beacon.get_AAAA");
      this.options.add(".dns-beacon.get_TXT");
      this.options.add(".dns-beacon.put_metadata");
      this.options.add(".dns-beacon.put_output");
      this.options.add(".stage.magic_mz_x86");
      this.options.add(".stage.magic_mz_x64");
      this.options.add(".stage.magic_pe");
      ...
      this.options.add(".stage.smartinject");
      this.options.add(".stage.allocator");
      ...
      this.options.add(".http-config.block_useragents");
      this.options.add(".http-config.allow_useragents");
      this.numbers.add(".sleeptime");
      this.numbers.add(".jitter");
      this.numbers.add(".data_jitter");
      this.numbers.add(".dns-beacon.maxdns");
      this.numbers.add(".dns-beacon.dns_sleep");
      ...
      this.numbers.add(".dns-beacon.dns_max_txt");
      this.numbers.add(".dns-beacon.dns_ttl");
      ...
      this.allocatorsrdll.add(".stage.allocator");
      this.ips.add(".dns-beacon.dns_idle");
      this.keyloggers.add(".post-ex.keylogger");
      ...
      this.A(".http-get.client.metadata", this.statementb, this.statementa);
      this.A(".http-get.server.output", this.statementb, this.statementa);
      this.A(".http-post.client.id", this.statementb, this.statementa);
      this.A(".http-post.client.output", this.statementb, this.statementa);
      this.A(".http-post.server.output", this.statementb, this.statementa);
      ...
      this.functionh.add(".post-ex.thread_hint");
   }

   private void A(String var1, Set var2, Set var3) {
         ...
         if (var6 == '\\' && var5.hasNext()) {
            ...
            if (var6 == 'u') {
               if (!var5.hasNext(4)) {
                  ...
                  String var4 = var5.next(4);

                  try {
                     int var7 = Integer.parseInt(var4, 16);
   ...
   public int parse(Token[] var1, int var2, String var3) {
      if (var2 + 3 < var1.length) {
         String var4 = var1[var2].toString();
         String var5 = var1[var2 + 1].toString();
         String var6 = var1[var2 + 2].toString();
         String var7 = var1[var2 + 3].toString();
         if (Checkers.isSetStatement(var4, var5, var6, var7)) {
            if (!this.options.contains(var3 + "." + var5)) {
               ...
               String var11 = this.convert(var6, var1[var2 + 2]);
               if (this.numbers.contains(var3 + "." + var5) && !Checkers.isNumber(var11)) {
                  this.parser.reportError("option " + A(var3 + "." + var5) + " requires a number", var1[var2 + 2]);
               }

               if (this.booleans.contains(var3 + "." + var5) && !Checkers.isBoolean(var11)) {
                  this.parser.reportError("option " + A(var3 + "." + var5) + " requires true or false", var1[var2 + 2]);
               }

               if (this.verbs.contains(var3 + "." + var5) && !Checkers.isHTTPVerb(var11)) {
                  this.parser.reportError("option " + A(var3 + "." + var5) + " requires a valid HTTP verb", var1[var2 + 2]);
               }

               if (this.ips.contains(var3 + "." + var5) && !CommonUtils.isIP(var11)) {
                  this.parser.reportError("option " + A(var3 + "." + var5) + " requires an IPv4 address", var1[var2 + 2]);
               }

               if (this.dates.contains(var3 + "." + var5) && !Checkers.isDate(var11)) {
                  this.parser.reportError("option " + A(var3 + "." + var5) + " requires a 'dd MMM YYYY hh:mm:ss' date", var1[var2 + 2]);
               }

               if (this.allocators.contains(var3 + "." + var5) && !Checkers.isAllocator(var11)) {
                  this.parser.reportError("option " + A(var3 + "." + var5) + " requires VirtualAllocEx or NtMapViewOfSection", var1[var2 + 2]);
               }

               if (this.allocatorsrdll.contains(var3 + "." + var5) && !Checkers.isAllocatorRDLL(var11)) {
                  this.parser.reportError("option " + A(var3 + "." + var5) + " requires VirtualAlloc, HeapAlloc, or MapViewOfFile", var1[var2 + 2]);
               }

               if (this.keyloggers.contains(var3 + "." + var5) && !Checkers.isKeyloggerMethod(var11)) {
                  this.parser.reportError("option " + A(var3 + "." + var5) + " requires GetAsyncKeyState or SetWindowsHookEx", var1[var2 + 2]);
               }

               if (this.files.contains(var3 + "." + var5)) {
                  String var9 = this.find(var11);
                  ...
                  FunctionHint var12 = new FunctionHint(var11);
                  String var10 = A(var3 + "." + var5);
                  if (var12.isValid(var10)) {
                     this.result.addParameter(var3 + "." + var5, var12.getDirective());
                  } else {
                     this.parser.reportError(var12.getError(), var1[var2 + 2]);
                  }
               } else {
                  this.result.addParameter(var3 + "." + var5, var11);
               }
         ...
         if (Checkers.isIndicator(var4, var5, var6, var7)) {
            String var9 = this.convert(var5, var1[var2 + 1]);
            String var10 = this.convert(var6, var1[var2 + 2]);
            if (!this.indicators.contains(var3 + "." + var4)) {
               if ("strrep".equals(var4)) {
                  this.parser.reportError("invalid token for " + A(var3), var1[var2]);
               } else {
                  this.parser.reportError("invalid indicator for " + A(var3), var1[var2]);
               }
      ...
      if (var2 + 2 < var1.length) {
         ...
         if (Checkers.isStatementArgBlock(var4, var5, var6)) {
            if (!this.variants.contains(var3 + "." + var4)) {
               this.parser.reportError("Variant block is not valid for " + A(var3), var1[var2]);
            } else {
               String var7 = this.convert(var5, var1[var2 + 1]);
               ...
               if (this.sealme.contains(var3 + "." + var4) && !this.result.isSealed(var3 + "." + var4)) {
                  this.parser.reportError("Program " + A(var3 + "." + var4) + " must end with a termination statement", var1[var2 + 2]);
               }
      ...
      if (var2 + 1 < var1.length) {
         ...
         if (Checkers.isStatementBlock(var4, var5)) {
            if (!this.blocks.contains(var3 + "." + var4)) {
               this.parser.reportError("Block is not valid for " + A(var3), var1[var2]);
            } else {
               this.parse(ParserUtilities.extract(var5), var3 + "." + var4, var1[var2 + 1].getHint());
               this.result.addCommand(var3, "build", var3 + "." + var4);
               if (this.sealme.contains(var3 + "." + var4) && !this.result.isSealed(var3 + "." + var4)) {
                  this.parser.reportError("Program " + A(var3 + "." + var4) + " must end with a termination statement", var1[var2 + 1]);
               }
            }
         ...
         if (Checkers.isStatement(var4, var5)) {
            if (!this.statementb.contains(var3 + "." + var4)) {
               this.parser.reportError("Statement is not valid for " + A(var3), var1[var2]);
            } else if (this.result.isSealed(var3)) {
               this.parser.reportError("Program is terminated. Can't add transform statements to " + A(var3), var1[var2]);
            } else {
      ...
      if (var2 < var1.length) {
         ...
         if (Checkers.isComment(var4)) {
            ...
            this.parser.reportError("Unknown statement in " + A(var3), var1[var2]);
            return 10000;
         }
      } else {
         return 0;
   ...
   private static class _A extends Parser {
      public _A(String var1) {
         super(var1, "");
      }

      public void A() throws YourCodeSucksException {
         if (this.hasErrors()) {
