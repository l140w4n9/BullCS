...
import static util.ModifiedBase64.modifiedBase64DecodeUrl;
...
public class Program implements Serializable {
    ...
    public void addStep(String var1, String var2) {
        Program.Statement var3 = new Program.Statement();
        var3.argument = var2;
        if (var2 != null) {
        ...
        if (var1.equals("append")) {
            ...
            var3.action = 14;
        } else if (var1.equals("mask")) {
            var3.action = 15;
        } else {
            if (!var1.equals("svg")) { // ADD
    ...
    public void transform(Profile var1, Response var2, SmartBuffer var3) {
        ...
        while(var4.hasNext()) {
            Program.Statement var6 = (Program.Statement)var4.next();
            String var5;
            switch(var6.action) {
                case 1:
                ...
                default:
                    ...
                    break;
                case 15:
                    var5 = A(MaskEncoder.encode(var3.getBytes()));
                    var3.clear();
                    var3.append(toBytes(var5));
                    break;
                case 51:
                    var5 = SvgPathEncode.encode(var3.getBytes());
                    var3.clear();
                    var3.append(toBytes(var5));
                    break;
            }
    ...
    public void collissions(Profile var1, String var2, Set var3, Map var4, List var5) {
        ...
        while(var6.hasNext()) {
            String var8 = null;
            String var9 = null;
            Program.Statement var10 = (Program.Statement)var6.next();
            String[] var7;
            switch(var10.action) {
                case 4:
                    var8 = "print";
    ...
    public String recover(Map var1, Map var2, String var3, String var4) {
        ...
        while(var6.hasNext()) {
            Program.Statement var7 = (Program.Statement)var6.next();
            switch(var7.action) {
                case 1:
                    try {
                ...
                case 13:
                    try {
                        var5 = A(modifiedBase64DecodeUrl(var5));
                        break;
                ...
                default:
                    ...
                    break;
                case 15:
                    var5 = A(MaskEncoder.decode(CommonUtils.toBytes(var5)));
            }
        }
    ...
    public byte[] getPrependedData() {
        if (this.tsteps.size() == 0) {
            ...
            while(var2.hasNext()) {
                Program.Statement var3 = (Program.Statement)var2.next();
                switch(var3.action) {
                    case 2:
