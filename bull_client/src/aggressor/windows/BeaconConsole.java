...
public class BeaconConsole extends AObject implements ActionListener, ConsolePopup, Callback {
	...
	public void result(String var1, Object var2) {
		if (var1.equals("beacons") && this.console.isShowing()) {
			...
			String var4 = this.engine.format(this.Script("SBAR_LEFT"), var6.eventArguments());
	...
	public boolean isVistaAndLater() {
		...
		if (var1 != null) {
			return var1.getVersion() >= (double)6.0F;
		} else {
			return false;
		}
	}
	...
	private void E(CommandParser var1, int var2, String var3) {
		...
		} else if (var1.isMissingArguments() && var1.verify("TRD")) {
			String var8 = var1.popString();
			String var5 = var1.popString();
			String var6 = var1.popString();
	...
	private void C(CommandParser var1, final int var2, final String var3) {
		if (var1.verify("AAF")) {
			...
			final String var4 = var1.popString();
			String var5 = var1.popString();
			final String var6 = CommonUtils.Host(var5);
	...
	public void actionPerformed(ActionEvent var1) {
		...
		try {
			...
			if (!var3.isEmpty()) {
				Console var213 = this.console;
				String var230 = this.formatLocal(BeaconOutput.Input(this.bid, var2));
				var213.append(var230 + "\n");
				var2 = var3;
			}
		} catch (Exception var10) {
			Console var10000 = this.console;
			String var10001 = this.formatLocal(BeaconOutput.Input(this.bid, var2));
			var10000.append(var10001 + "\n");
			var10000 = this.console;
			var10001 = this.formatLocal(BeaconOutput.Error(this.bid, var10.getMessage()));
			var10000.append(var10001 + "\n");
			return;
		}
		...
		if (this.client.getAliases().isAlias(var11.getCommand())) {
		...
		} else if (!var11.is("help") && !var11.is("?")) {
			if (var11.is("history")) {
				Console var218 = this.console;
				String var235 = this.formatLocal(BeaconOutput.Input(this.bid, var2));
				var218.append(var235 + "\n");
				int var14 = var11.popHistoryArgument();
				if (var11.hasError()) {
					var218 = this.console;
					var235 = this.formatLocal(BeaconOutput.Error(this.bid, var11.error()));
					var218.append(var235 + "\n");
				} else {
					this.getConsole().showHistory(var14);
				}
			} else if (var11.is("downloads")) {
				Console var220 = this.console;
				String var237 = this.formatLocal(BeaconOutput.Input(this.bid, var2));
				var220.append(var237 + "\n");
				...
				Console var227 = this.console;
				String var244 = this.formatLocal(BeaconOutput.Input(this.bid, var2));
				var227.append(var244 + "\n");
				var227 = this.console;
				Cortana var245 = this.engine;
				Stack var249 = new Stack();
				var227.append(var245.format("BEACON_OUTPUT_EXPLOITS", var249) + "\n");
			} else if (var11.is("runasadmin") && var11.empty()) {
				Console var225 = this.console;
				String var242 = this.formatLocal(BeaconOutput.Input(this.bid, var2));
				var225.append(var242 + "\n");
				var225 = this.console;
				Cortana var243 = this.engine;
				Stack var248 = new Stack();
				var225.append(var243.format("BEACON_OUTPUT_ELEVATORS", var248) + "\n");
			} else if (var11.is("remote-exec") && var11.empty()) {
				Console var223 = this.console;
				String var240 = this.formatLocal(BeaconOutput.Input(this.bid, var2));
				var223.append(var240 + "\n");
				var223 = this.console;
				Cortana var241 = this.engine;
				Stack var247 = new Stack();
				var223.append(var241.format("BEACON_OUTPUT_REMOTE_EXEC_METHODS", var247) + "\n");
			} else if (var11.is("jump") && var11.empty()) {
				Console var221 = this.console;
				String var238 = this.formatLocal(BeaconOutput.Input(this.bid, var2));
				var221.append(var238 + "\n");
				var221 = this.console;
				Cortana var239 = this.engine;
				Stack var246 = new Stack();
				var221.append(var239.format("BEACON_OUTPUT_REMOTE_EXPLOITS", var246) + "\n");
			} else {
				this.master.input(var2);
				if (var11.is("argue")) {
					if (!this.isVistaAndLater()) {
						...
						if (!var11.verify("A") && !var11.reset()) {
							...
							String var4 = var11.popString();
							this.master.SpoofArgsRemove(var4);
						}
					} else {
						String var4 = var11.popString();
						String var12 = var11.popString();
					...
					if (!var11.verify("AI") && !var11.reset()) {
						...
						int var14 = var11.popInt();
						String var12 = var11.popString();
						this.master.Connect(var12, var14);
					}
				} else if (var11.is("covertvpn")) {
					BeaconEntry var15 = DataUtils.getBeacon(this.data, this.bid);
					if (var11.verify("AA")) {
						String var12 = var11.popString();
						String var16 = var11.popString();
					...
					if (!var11.verify("IXZ") && !var11.reset()) {
						...
						String var4 = var11.popString();
						String var12 = var11.popString();
						int var17 = var11.popInt();
						var11.reset();
						CommandParser var7 = new CommandParser("dcsync " + var4);
					...
					if (var11.verify("AL")) {
						...
						final String var12 = var11.popString();
						if (var24.isExploit(var12)) {
							ScListenerChooser var19 = ScListenerChooser.ListenersAll(this.client, new SafeDialogCallback() {
								public void dialogResult(String var1) {
					...
					if (!var11.verify("IXL") && !var11.reset()) {
						if (!var11.verify("IX") && !var11.reset()) {
							if (var11.verify("IL")) {
								...
								final int var14 = var11.popInt();
								ScListenerChooser var27 = ScListenerChooser.ListenersAll(this.client, new SafeDialogCallback() {
									public void dialogResult(String var1) {
							...
							final String var4 = var11.popString();
							final int var13 = var11.popInt();
							ScListenerChooser var19 = ScListenerChooser.ListenersAll(this.client, new SafeDialogCallback() {
								public void dialogResult(String var1) {
					...
					if (var11.verify("AAL")) {
						...
						final String var12 = var11.popString();
						final String var16 = var11.popString();
					...
					if (!var11.verify("AA") && !var11.reset()) {
						if (var11.verify("Z")) {
							String var4 = var11.popString();
							String var12 = DataUtils.getDefaultPipeName(this.client.getData(), var4);
					...
					if (var11.verify("AZ")) {
						...
						if (var12.indexOf("\\") == -1) {
							...
							String var18 = var25.shift();
							String var8 = var25.shift();
				...
				} else if (var11.is("net")) {
					if (var11.verify("IXVZ")) {
						String var4 = var11.popString();
						String var12 = var11.popString();
						String var16 = var11.popString();
						int var21 = var11.popInt();
						var11.reset();
						CommandParser var22 = new CommandParser("net " + var12 + " " + var4);
						...
						int var17 = var11.popInt();
						var11.reset();
						CommandParser var7 = new CommandParser("net " + var4);
					...
					if (var11.verify("IXZ")) {
						...
						int var17 = var11.popInt();
						var11.reset();
						CommandParser var7 = new CommandParser("portscan " + var4);
					...
					if (!var15.isAdmin()) {
						...
						int var21 = var11.popInt();
						var11.reset();
						CommandParser var22 = new CommandParser("pth " + var12);
					...
					this.master.Pwd();
				} else if (var11.is("deleteself")) {
					this.master.DeleteSelf();
				}
					...
					if (var11.verify("AAZ")) {
						...
						if (var16.indexOf("\\") == -1) {
							...
							StringStack var26 = new StringStack(var16, "\\");
							String var8 = var26.shift();
							String var9 = var26.shift();
				...
				} else if (var11.is("hook")) {
					if (var11.verify("Z")) {
						this.master.Hook(var11.popString());
					}
					...
					if (!var11.verify("IXZ") && !var11.reset()) {
						...
						int var17 = var11.popInt();
						var11.reset();
						CommandParser var7 = new CommandParser("ssh " + var4);
					...
					if (!var11.verify("IXZ") && !var11.reset()) {
						...
						int var17 = var11.popInt();
						var11.reset();
						CommandParser var7 = new CommandParser("ssh-key " + var4);
					...
					String var18;
					if (var11.is("arp")) {
						var18 = var11.getArguments();
						this.master.arp(var18);
					}else if (var11.is("whoami")) {
						var18 = var11.getArguments();
						this.master.whoami(var18);
					} else if (var11.is("env")) {
						var18 = var11.getArguments();
						this.master.env(var18);
					}else if (var11.is("cat")) {
						var18 = var11.getArguments();
						if (var18 == "") {
							var11.error("Please enter a file name");
						} else {
							this.master.cat(var18);
						}
					}else if (var11.is("syscalls_inject")) {
						var18 = var11.getArguments();
						if (var18 == "") {
							var11.error("Parameter error, Enter \"help syscalls_inject\" for more details");
						} else {
							this.master.syscalls_inject(var18);
						}
					}else if (var11.is("syscalls_shinject")) {
						var18 = var11.getArguments();
						if (var18 == "") {
							var11.error("Parameter error, Enter \"help syscalls_shinject\" for more details");
						} else {
							this.master.syscalls_shinject(var18);
						}
					}else if (var11.is("ipconfig")) {
						var18 = var11.getArguments();
						this.master.ipconfig(var18);
					} else if (var11.is("netstat")) {
						var18 = var11.getArguments();
						this.master.netstat(var18);
					} else if (var11.is("routeprint")) {
						var18 = var11.getArguments();
						this.master.routeprint(var18);
					} else if (var11.is("openport")) {
						var18 = var11.getArguments();
						if (var18 == "") {
							var11.error("Parameter error, Enter \"help openport\" for more details");
						} else {
							this.master.openport(var18);
						}
					}else if (var11.is("uacscan")) {
						var18 = var11.getArguments();
						this.master.uacscan(var18);
					}else if (var11.is("uac2")) {
						var18 = var11.getArguments();
						if (var18 == "") {
							var11.error("Please enter the executable file path");
						} else {
							this.master.uac2(var18);
						}
					}else if (var11.is("uacsspi")) {
						var18 = var11.getArguments();
						if (var18 == "") {
							var11.error("Please enter the executable file path");
						} else {
							this.master.uacsspi(var18);
						}
					}else if (var11.is("pythonBOF")) {
						var18 = var11.getArguments();
						if (var18 == "") {
							var11.error("Please enter the python file path");
						} else {
							this.master.pythonBOF(var18);
						}
					}else if (var11.is("screenshotp")) {
						var18 = var11.getArguments();
						this.master.screenshotp(var18);
					}
					else{
			...
			Console var214 = this.console;
			String var231 = this.formatLocal(BeaconOutput.Input(this.bid, var2));
			var214.append(var231 + "\n");
			if (!var11.verify("Z") && !var11.reset()) {
				var214 = this.console;
				Cortana var233 = this.engine;
				Stack var10003 = new Stack();
				var214.append(var233.format("BEACON_OUTPUT_HELP", var10003) + "\n");
			} else {
				String var4 = var11.popString();
				...
				if (var5.isHelpAvailable(var4)) {
					...
					var214 = this.console;
					var231 = this.engine.format("BEACON_OUTPUT_HELP_COMMAND", var6);
					var214.append(var231 + "\n");
				} else {
			...
			if (var11.hasError()) {
				var214 = this.console;
				var231 = this.formatLocal(BeaconOutput.Error(this.bid, var11.error()));
				var214.append(var231 + "\n");
			}
		}
