...
public class BeaconOutput implements Serializable, Transcript, Loggable, Informant, Scriptable {
	...
	public static final short OUTPUT_UACSCAN = 31;
	public String from;
	public long when;
	public short type;
	public String text;
	...
	public String eventName() {
		...
		case OUTPUT_UACSCAN:
			return this.prefix("output_uacscan");
		}
	}
	...
	public static final BeaconOutput Note(String var0, String var1) {
		return new BeaconOutput(var0, (short)12, var1);
	}
	...
	public static final BeaconOutput OutputUacscan(String var0, String var1) {
		return new BeaconOutput(var0, OUTPUT_UACSCAN, var1);
	}
	...
	public void formatEvent(DataOutputStream var1) throws IOException {
		if (this.type != 11) {
			...
			default:
				break;
			case 12:
				CommonUtils.writeUTF8(var1, "[note] " + this.text);
			}
